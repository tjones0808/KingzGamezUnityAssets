...
public class bl_EventHandler
{
    ...
    public delegate void EffectChange(bool chrab,bool anti,bool bloom, bool ssao);
    ...
    public static void PlayerLocalSpawnEvent(bool chrab, bool anti, bool bloom, bool ssao)
    {
        if (OnEffectChange != null)
        {
            OnEffectChange(chrab,anti,bloom,ssao);
        }
    }
