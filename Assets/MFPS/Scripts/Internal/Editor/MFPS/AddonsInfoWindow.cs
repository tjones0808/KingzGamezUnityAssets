...
public class AddonsInfoWindow : EditorWindow
{
    ...
    {
        AddonsInfoWindow window = EditorWindow.GetWindowWithRect<AddonsInfoWindow>(new Rect(100f, 100f, 450f, 390f), true, "Addons Info");
        window.position = new Rect(100f, 100f, 450, 390f);
    }
