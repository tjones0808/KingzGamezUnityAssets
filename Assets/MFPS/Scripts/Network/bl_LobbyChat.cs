...
public class bl_LobbyChat : MonoBehaviour, IChatClientListener
{
    ...
    public void Start()
    {
        ...
        {
            Debug.LogWarning("You need to set the chat app ID in the PhotonServerSettings file in order to use Lobby Chat.");
    ...
    public void Connect(string version)
    {
        ...
        this.chatClient.Connect(PhotonNetwork.PhotonServerSettings.ChatAppID, version, new ExitGames.Client.Photon.Chat.AuthenticationValues(PhotonNetwork.playerName));
    }
    ...
    public void OnConnected()
    {
        ...
        UserIdText.text = "Connected as " + PhotonNetwork.playerName;
