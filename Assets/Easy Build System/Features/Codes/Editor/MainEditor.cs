    ...
    public class MainEditor : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            if (NavigationIndex == 0)
            {
                ...
                GUILayout.Label("Add-On(s) :", EditorStyles.boldLabel);
            ...
            if (NavigationIndex == 1)
            {
                ...
                GUILayout.Label("Integration(s) :", EditorStyles.boldLabel);
                ...
                AddIntegration("(Devdog) Inventory Pro", "/content/66801", "DEVDOG", "Requires version 2.5 or higher of Inventory Pro.", null, null);

                //Soon
                //AddIntegration("(Devdog) Rucksack", "/content/114921", "DEVDOG", "", null, null);

                AddIntegration("(Vis2k) uSurvival", "/content/95015", "VIS2K", "This integration is likely to change in future releases.", null, null);
