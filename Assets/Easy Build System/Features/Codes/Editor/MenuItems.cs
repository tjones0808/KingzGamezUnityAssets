using EasyBuildSystem.Editor.Runtimes.Extensions;
...
namespace EasyBuildSystem.Codes.Editor
{
    public class MenuItems : ScriptableObject
    {
        ...
        [MenuItem("Tools/Easy Build System/Scriptable Object(s)/Create New Inputs Collection...", priority = 50)]
        public static void EditorCreateInputsCollection()
        {
            ScriptableObjectExtension.CreateAsset<InputsCollection>("New Inputs Collection...");
        }
