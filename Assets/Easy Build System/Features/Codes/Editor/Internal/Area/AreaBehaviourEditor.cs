...
namespace EasyBuildSystem.Codes.Editor.Internal.Area
{
    ...
    public class AreaBehaviourEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Label("Area Behaviour Settings", EditorStyles.boldLabel);
            ...
            GUILayout.Label("Area Add-On(s) Settings", EditorStyles.boldLabel);
