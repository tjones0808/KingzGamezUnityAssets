...
namespace EasyBuildSystem.Codes.Editor.Internal.Group
{
    ...
    public class GroupBehaviourEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Label("Group Behaviour Settings", EditorStyles.boldLabel);
            ...
            GUILayout.Label("Group Add-On(s) Settings", EditorStyles.boldLabel);
