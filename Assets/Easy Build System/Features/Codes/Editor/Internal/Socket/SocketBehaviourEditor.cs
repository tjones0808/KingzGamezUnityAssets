...
namespace EasyBuildSystem.Codes.Editor.Internal.Socket
{
    ...
    public class SocketBehaviourEditor : UnityEditor.Editor
    {
        ...
        private static bool EditorPreviewFoldout;
            ...
            if (ShowPartOffsetEditor)
            {
                if (CurrentOffset != null)
                {
                    ...
                    else
                    {
                        ...
                        PreviewPart.transform.position = Target.transform.position + CurrentOffset.Position;

                        PreviewPart.transform.rotation = Target.transform.rotation * Quaternion.Euler(CurrentOffset.Rotation);

                        PreviewPart.transform.localScale = (CurrentOffset.UseCustomScale ? CurrentOffset.Scale : PreviewPart.transform.localScale);
                    }
                }
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Label("Socket Behaviour Settings", EditorStyles.boldLabel);
            ...
            if (GUILayout.Button(AllIsOpen ? "Fold In" : "Fold Out", GUILayout.Width(80)))
            {
                ...
                EditorPreviewFoldout = !EditorPreviewFoldout;
            ...
            GUILayout.Label("Socket Offset(s) Settings", EditorStyles.boldLabel);
            ...
            if (OffsetsFoldout)
            {
                ...
                else
                {
                    ...
                    foreach (PartOffset Offset in Target.PartOffsets)
                    {
                        ...
                        GUILayout.Label("(ID:" + Offset.Part.Id + ") " + Offset.Part.Name, EditorStyles.boldLabel);
            ...
            GUILayout.Label("Socket Utilities Settings", EditorStyles.boldLabel);
            ...
            GUILayout.Label("Socket Add-Ons Settings", EditorStyles.boldLabel);
        ...
        private void OnOffsetEditingWindow(int windowId)
        {
            ...
            GUILayout.Label("Part Offset(s) Settings", EditorStyles.boldLabel);
        ...
        private void CreatePreview(PartOffset offsetPart)
        {
            ...
            if (PreviewPart == null)
            {
                PreviewPart = Instantiate(offsetPart.Part.gameObject);
                ...
                PreviewPart.transform.localScale = (offsetPart.UseCustomScale ? offsetPart.Scale : PreviewPart.transform.localScale);
