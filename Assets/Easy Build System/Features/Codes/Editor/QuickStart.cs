using EasyBuildSystem.Codes.Editor;
using System;
using UnityEditor;
using UnityEngine;
...
public class QuickStart : MonoBehaviour
{
    ...
    public static void Init()
    {
        try
        {
            ...
            if (Camera.main != null)
            {
                if (FindObjectOfType<DefaultBuilderBehaviour>() == null)
                    Camera.main.gameObject.AddComponent<DefaultBuilderBehaviour>();
                else
                {
                    Debug.LogError("<b><color=red>[Easy Build System]</color></b> : The component <b>Default Builder Behaviour</b> already exists.");
